...
| warning(ワーニング) | 警告.直さなくてもビルドできるが,バグの原因かもしれない. |
| message(メッセージ) | 直前のエラーまたはメッセージに関するヒント. |

`修正手順`
>1. 直したいメッセージをダブルクリックして,<br>
メッセージを発生させた行を表示する.
>2. 表示された行とメッセージの内容を見比べて,<br>
 エラーまたは警告の原因を特定する.
>3. 原因が「表示された行の前の行」にある<br>
(「行末にセミコロンがない」など)場合もあるので,<br>
前の行も調べること.
>4. 原因を特定したら,プログラムを修正する.
>5. ビルドを行い,メッセージが<br>
表示されないことを確認する.
>6. 修正してもメッセージが消えない場合は<br>
1に戻り,修正方法を改善する.
